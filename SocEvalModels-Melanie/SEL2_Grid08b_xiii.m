...
%  SEL2_Grid08*_**  : MAP fitting, with weakly informative priors 
...
%          08 fits :  As per 06b, but also has lapse rate which admixes ordinary 'flat' lapse, and frees most params :)
%                        1           2          3       4:tied to 3    5          6:tied to 5     7       8         9     10    11      12       13  
%                       'posiSelf','posiOther','dEvSelf','dEvOther',   'aEvSelf','aEvOther',  'alphaPrec','genLR','repLR','wp0','wAttr','mem',   lps 
%           08b     : b is about retaining only the first of blocks of the same 
...
fitStr = '08b';   % short string to identify the fitting version in outputs / file
...
parNOTTOFIT = [4, 6]; % ,    5, 8, 12, 13];  % 5,8, 12, 13 will probably have to be freed for nice fits :)  
...
for ptN = todo
    ...
    % parHd={'posiSelf','posiOther','dEvSelf','dEvOther','aEvSelf','aEvOther','alphaPrec','genLR','repLR','wp0','wAttr','mem','lps'};
     parOrdGrid = [1 2 5 3 7 12 8 9 10 11 13    5 1 2 3 12 7 9 10 8 11 13];  % in order above in hd. Cycle repeatedly!
