...
CumBlockMResp(counter) = cumsum(Resp(counter))/(counter); %attempt to find the cumulative mean resp for all the trials per block
plot(CumBlockMeanPosResp,trialN,"-")
