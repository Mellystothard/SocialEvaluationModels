function optPetc = SEL2_Grid04b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
%  function optPetc = SEL2_Grid04b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
...
%           04b     : b is about retaining only the first of blocks of the same 
...
fitStr = '04b';   % short string to identify the fitting version in outputs / file
...
for ptN = todo
    ...
    % parHd={'posiSelf','posiOther','dEvSelf','dEvOther','aEvSelf','aEvOther','alphaPrec','genLR','repLR','wp0','wAttr','mem'};
     parOrdGrid = [1 2 3 7 9 10 11 1 2 3 7 9 10 11 ];  % in order above in hd. Cycle repeatedly!
