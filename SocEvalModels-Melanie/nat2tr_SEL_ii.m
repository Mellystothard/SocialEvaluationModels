function transfP8 = nat2tr_SEL_ii(par8,vecInOut)
% transfP8 = nat2tr_SEL_i(par8)  : Transform up-to-13 param vector
...
% e.g. [0.75,      0.5,      1,      1,       2,       2,      5,      0.25,  0.8,  0,  6,     0.9998, 0.05];
try 
    vecInOut; 
catch
...
if ~isempty(par8)
    ...
    if vecInOut
        ...
        transfP8(13)= log(par8(12)/(1-par8(13)));
    else
        ...
        transfP8.lps= log(par8.mem/(1-par8.lps));
    end
