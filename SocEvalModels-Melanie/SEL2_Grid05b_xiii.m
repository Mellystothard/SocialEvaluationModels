function optPetc = SEL2_Grid05b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
%  function optPetc = SEL2_Grid05b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
...
%  SEL2_Grid05*_**  : MAP fitting, with weakly informative priors 
...
%          05 fits :  As per 04b, but also has lapse rate which admixes (blunted) mirrored lapse.
...
%           05b     : b is about retaining only the first of blocks of the same 
...
%   optPtest = SEL2_Grid05b_xiii(selAIdat,1,synParF,1,100,2,fitD,0);     % 12,5,20,fitD,0)
%
...
fitStr = '05b';   % short string to identify the fitting version in outputs / file
