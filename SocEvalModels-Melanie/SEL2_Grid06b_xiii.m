function optPetc = SEL2_Grid06b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
%  function optPetc = SEL2_Grid06b_xiii(selAIFile, batch2fit, initTrParFile, grN, grSc, batchSize, fitDir, codeTest )
...
%  SEL2_Grid06*_**  : MAP fitting, with weakly informative priors 
...
%          06 fits :  As per 04b, but also has lapse rate which admixes ordinary 'flat' lapse.
%                        1           2          3       4:tied to 3    5:fixed    6:tied to 5     7       8:fixed    9     10    11    12:fixed   13  
%                       'posiSelf','posiOther','dEvSelf','dEvOther',   'aEvSelf','aEvOther',  'alphaPrec','genLR','repLR','wp0','wAttr','mem',   lps };

%           06b     : b is about retaining only the first of blocks of the same 
...
%   optPtest = SEL2_Grid06b_xiii(selAIdat,1,synParF,1,100,2,fitD,0);     % 12,5,20,fitD,0)
%
...
fitStr = '06b';   % short string to identify the fitting version in outputs / file
...
for ptN = todo
    ...
    % parHd={'posiSelf','posiOther','dEvSelf','dEvOther','aEvSelf','aEvOther','alphaPrec','genLR','repLR','wp0','wAttr','mem','lps'};
     parOrdGrid = [1 2 3 7 9 10 11 13 1 2 3 7 9 10 11 13];  % in order above in hd. Cycle repeatedly!
