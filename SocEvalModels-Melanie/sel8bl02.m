function [fitM, Par8, MDP8] = sel8bl02( pTr8, inp8, resp8, modStruc8, details)
...
for blN = 1:totBlocks
    ...
    if blN == 1  % i.e. use the input parameters straight - no learning to do! ====================
        ...
        selfP = spm_unvec(rateeP,modStruc8.indexP);
        transfP = nat2tr_mdp_L_xii(selfP);

        MDP8{blN} = spm_mdp_L_xii(transfP,modStruc8,inp8{blN},resp8{blN},details); %main structure of MDPs, 
       ...
       % Check if rater has been repeated, and if so when last:
        ...
        selfP = spm_unvec(rateeP,modStruc8.indexP);
        transfP = nat2tr_mdp_L_xii(selfP);
        MDP8{blN} = spm_mdp_L_xii(transfP,modStruc8,inp8{blN},resp8{blN},details); %main structure 
